...
cell_directory = 'custom_stdcell/a22oi_1x/'
spice_file = path.join(cell_directory, "a22oi_1x.spice")
...
sim_step = '0.1n' # Controls the speed of Characterization (0.1n for faster results-> less accurate)
...
input_pins = 'a0 a1 b0 b1' # TODO: extract from .lef files
output_pins = 'y' # TODO: extract from .lef files
logic_function = 'not ((a0 and a1) or (b0 and b1))' # Use keyword 'not', 'and' , 'or'